...
const AboutUs = () => {
  return (
    <div className="mt-6 md:mt-2 py-10 md:py-20 bg-[#b0c4de2d] md:px-8 px-4 roboto-serif-font">
     <div className="flex flex-col items-center md:flex-row">
         <div className="w-full md:w-1/2 flex justify-center mx-auto">
        <img src={car1} alt="" className="w-full max-w-sm md:max-w-md mx-auto" />
      </div>
      <div className="w-full md:w-2/5 md:mx-10">
        ...
        <p className="mt-3 text-base md:text-xl">
          ...
          rental service offers safe, affordable, and well-maintained vehicles.
        </p>
        <p className="mt-3 text-base md:text-xl">
